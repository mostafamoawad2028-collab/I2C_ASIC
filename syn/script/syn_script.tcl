...
analyze -library work -format verilog ../rtl/i2c_master_defines.v
analyze -library work -format verilog ../rtl/i2c_master_bit_ctrl.v
analyze -library work -format verilog ../rtl/i2c_master_byte_ctrl.v
analyze -library work -format verilog ../rtl/timescale.v
