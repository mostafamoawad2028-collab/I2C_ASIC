...
set project_dir "/mnt/hgfs/VM_shared/ITI/ASIC_I2C"
set lib_path "/home/ICer/Downloads/Lib"
set dlib_dir "/mnt/hgfs/VM_shared/ITI/ASIC_I2C/pnr/2_design_lib/results/worst/outputs"
...
set_clock_routing_rules -net_type root -clocks {wb_clk_i} -rules clk_network_NDR_root -max_routing_layer M7 -min_routing_layer M5
set_clock_routing_rules -net_type internal -clocks {wb_clk_i} -rules clk_network_NDR_internal -max_routing_layer M5 -min_routing_layer M3
set_clock_routing_rules -net_type sink -clocks {wb_clk_i} -default_rule  -max_routing_layer M3 -min_routing_layer M1
...
set_max_transition 1 -clock_path    [get_clocks wb_clk_i]
set_max_capacitance 100 -clock_path [get_clocks wb_clk_i]
